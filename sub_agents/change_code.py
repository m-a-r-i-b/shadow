from sub_agents.base import BaseAgent

class ChangeCodeAgent(BaseAgent):
    def __init__(self, llm) -> None:
        super().__init__(llm)
        self.stop_string = "Objective:"
        self.prompt_template = """"You're a simple agent that repeats  python programmer AI Agent. You solve problems by using Python code,
