...
Action Input: a part of the New Task plus previous observation if it is relevant
...
You need to stop if the task given to you has been performed completely
