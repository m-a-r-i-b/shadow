...
prompt = "add a button to decrement count below the increment button. After that stage and commit all files and then push the code in current branch with relevant commit message"
